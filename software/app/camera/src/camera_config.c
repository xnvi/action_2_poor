...
// 超大帧阈值，超过此大小进行重编或丢弃
const HI_U32 g_u32SuperFrameSize = 512 * 1024;
...
// VPSS 扩展通道先做裁剪后做缩放
// PIC_PREVIEW 视频预览显示尺寸，经过缩放后裁剪到这个大小
const HI_U32 preview_crop_u32Width  = 1440;
const HI_U32 preview_crop_u32Height = 1080;
// PIC_PREVIEW 视频预览缩放尺寸，VPSS 等比缩放到这个大小，也是最终显示的大小
const HI_U32 preview_u32Width  = PREVIEW_WIDTH;
const HI_U32 preview_u32Height = PREVIEW_HEIGHT;
